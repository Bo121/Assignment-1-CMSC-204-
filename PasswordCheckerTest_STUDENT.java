...
public class PasswordCheckerTest_STUDENT {
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("qazxs"));
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("asdfghjk"));
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("ASDXCDF1"));
	...
	public void testIsWeakPassword()
	{
		try{
			...
			boolean weakPwd = PasswordCheckerUtility.isWeakPassword("asd123@");
	...
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValidPassword("BBBa!1a%sd"));
	...
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValidPassword("BBa!a%sasd"));
		...
		{
			System.out.println(e.getMessage());
			assertTrue("Threw some other exception besides an LengthException",true);
		}
	...
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValidPassword("Acsw123@#$%^"));
